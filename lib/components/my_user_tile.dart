...
This is to display each user as a nice tile. We will use this when we need to display a 
list of users, for e.g. in the user search results or viewing the followers of a user.
